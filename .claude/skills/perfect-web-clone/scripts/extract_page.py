...
class PageExtractor:
    ...
    async def extract(self, url: str, wait_time: int = 3000, max_depth: int = 20,
        ...
        try:
            ...
            # Animation-heavy sites may keep long-lived media/module requests
            # pending forever. `commit` gives us the response and live document;
            # the explicit wait below controls when extraction begins.
    ...
    async def _scroll_page(self, page, max_scrolls: int = 24, scroll_delay: float = 0.15):
