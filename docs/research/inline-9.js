  ...
  const canLabels = ['https://cdn.mprez.fr/ciaoenergy/textures/V4/ciao-energy_texture_double-litchi.avif', 'https://cdn.mprez.fr/ciaoenergy/textures/V4/ciao-energy_texture_coco-citron-vert.avif', 'https://cdn.mprez.fr/ciaoenergy/textures/V4/ciao-energy_texture_Kiwi-Concombre.avif', 'https://cdn.mprez.fr/ciaoenergy/textures/V4/ciao-energy_texture_peche-blanche.avif', 'https://cdn.mprez.fr/ciaoenergy/textures/V4/ciao-energy_texture_pomme-rhubarbe.avif', 'https://cdn.mprez.fr/ciaoenergy/textures/V4/ciao-energy_texture_abricot_framboise.avif'];
  ...
  hdriLoader.load('https://cdn.mprez.fr/ciaoenergy/webgl/hdri2.hdr', function (texture) {
  ...
  const baseGltf = await gltfLoader.loadAsync('https://cdn.mprez.fr/ciaoenergy/webgl/base.glb');
  ...
  const canGltf = await gltfLoader.loadAsync('https://cdn.mprez.fr/ciaoenergy/webgl/can.glb');

  const canMetallic = new THREE.TextureLoader().load('https://cdn.prod.website-files.com/69fb53371d5b8e9c3f4e4c69/6a0edb0e83db8ea830f2875d_5b37bb5107a2849b546a7b5d4bd06ef4_can-metallic-2.avif');
